...
function App() {
  ...
  return <div className={`app ${dark ? 'theme-dark' : 'theme-light'}`}>
    <style>{`.navbar .brand{position:absolute;left:50%;transform:translateX(-50%);z-index:2}.hero-search{width:min(620px,100%);margin:18px auto 0}`}</style>
